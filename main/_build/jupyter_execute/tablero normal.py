...
ea_tablero = df.query("variable== 'ea-oficinas-tablero-normal-hora'").copy()
fp_tablero = df.query("variable== 'factor-potencia-tablero-normal'").copy()
corriente_1 = df.query("variable== 'corriente-l1'").copy()
corriente_2 = df.query("variable== 'corriente-l2'").copy()
corriente_3 = df.query("variable== 'corriente-l3'").copy()
tension_1 = df.query("variable== 'tension-fase-l1'").copy()
tension_2 = df.query("variable== 'tension-fase-l2'").copy()
tension_3 = df.query("variable== 'tension-fase-l3'").copy()
...
# ## Tablero Normal Oficinas

# Analizaremos la carga Tablero Normal Oficinas, la cual tuvo el siguiente patrón de consumo de energía: 
# - Noviembre: 3476 kWh/mes
# - Diciembre: 5594 kWh/mes
...
desbalance_c['promedio'] = desbalance_c[['corriente-l1', 'corriente-l2', 'corriente-l3']].mean(axis=1).round(2)
...
min_values = desbalance_c[['corriente-l1', 'corriente-l2', 'corriente-l3']].min(axis=1)
...
desbalance_t['promedio'] = desbalance_t[['tension-fase-l1', 'tension-fase-l2', 'tension-fase-l3']].mean(axis=1).round(2)

# Calcular el valor promedio
promedio_t = desbalance_t['promedio']

# Calcular el valor mínimo de las columnas 'corriente-l1', 'corriente-l2' y 'corriente-l3'
min_values_t = desbalance_t[['tension-fase-l1', 'tension-fase-l2', 'tension-fase-l3']].min(axis=1)
