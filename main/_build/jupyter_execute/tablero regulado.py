...
ea_tablero = df.query("variable== 'ea-oficinas-tablero-regulado-hora'").copy()
fp_tablero = df.query("variable== 'factor-potencia-tablero-regulado'").copy()
corriente_1 = df.query("variable== 'corriente-l1-regulado'").copy()
corriente_2 = df.query("variable== 'corriente-l2-regulado'").copy()
corriente_3 = df.query("variable== 'corriente-l3-regulado'").copy()
tension_1 = df.query("variable== 'tension-fase-l1-regulado'").copy()
tension_2 = df.query("variable== 'tension-fase-l2-regulado'").copy()
tension_3 = df.query("variable== 'tension-fase-l3-regulado'").copy()
...
desbalance_c['promedio'] = desbalance_c[['corriente-l1-regulado', 'corriente-l2-regulado', 'corriente-l3-regulado']].mean(axis=1).round(2)
...
min_values = desbalance_c[['corriente-l1-regulado', 'corriente-l2-regulado', 'corriente-l3-regulado']].min(axis=1)
...
desbalance_t['promedio'] = desbalance_t[['tension-fase-l1-regulado', 'tension-fase-l2-regulado', 'tension-fase-l3-regulado']].mean(axis=1).round(2)

# Calcular el valor promedio
promedio_t = desbalance_t['promedio']

# Calcular el valor mínimo de las columnas 'corriente-l1', 'corriente-l2' y 'corriente-l3'
min_values_t = desbalance_t[['tension-fase-l1-regulado', 'tension-fase-l2-regulado', 'tension-fase-l3-regulado']].min(axis=1)
